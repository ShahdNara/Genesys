        ...
        <ScrollWrapper onWheelCapture={onScroll} ref={ref}>
            ...
            <Container>
                ...
                <Content>
                    ...
                    <Character icon={Legion} left color="white" title="The High Council" text="The ruling governmental body of Genesys. In the corporate structure of Genesys, the High Council is essentially the board of directors with a Chair(wo)man that effectively serves as the president and head of state. "/>
                </Content>
            </Container>
        </ScrollWrapper>
    )    
